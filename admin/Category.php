...
<body>
    ...
    <script>
        ...
        function deleteCategory(categoryId) {
            ...
            fetch('admFunctions.php?action=deleteCategory&id=' + categoryId)
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        alert(data.error); // Feedback to user
                    }
                })
                .catch(error => {
                    console.error('Error deleting category:', error);
                    alert('Failed to delete category: ' + error.message); // Feedback to user
                });
        }
    </script>
</body>
